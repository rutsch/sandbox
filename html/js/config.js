var objConfig = {
	urls: {
		...
		snapshoturl: 'https://www.livesimproved.philips.com/tools/dynamic_resources_cached_closed.aspx',
		simulationdataurl: 'https://www.livesimproved.philips.com/tools/dynamic_resources_cached_closed.aspx'
	},
	colors:{
		philips: {
			low: '#7DABF1',
